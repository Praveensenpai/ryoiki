...
echo -e " 1. Open: ${BOLD}https://github.com/settings/ssh/new${NC}"
echo -e " 2. Title: e.g. ${BOLD}Ubuntu Server ($(hostname))${NC}"
echo -e " 3. Key type: ${BOLD}Authentication Key${NC}"
echo -e " 4. Paste the key displayed above and click ${BOLD}'Add SSH key'${NC}"
echo ""
